...
class Student:
    def __init__(self, name, student_id):#метод, кот вызыв-ся авт-ки при создаии нового обьекта
    ...
    def add_grade(self, grade): # Добавляем оценку в список оценок студента, собирает все оценки и вычисл их ср зн
    ...
    def get_average(self): # Вычисляем средний балл студента, возвр ср ар всех оценок в списке self.grades
        if not self.grades:
    ...
    def display_info(self):#выводит и возвр на экран инфо о сост обьекта
...
class Teacher(Person):#наслед чел
